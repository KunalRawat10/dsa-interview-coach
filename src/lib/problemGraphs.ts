...
export const CONTAINS_DUPLICATE_CANONICAL: ApproachGraph = {
  ...
  nodes: [
    ...
    },
    {
      ...
      expectedEvidencePatterns: ['compare', 'check each', 'all pairs', 'nested loop', 'nested loops', 'check each against', 'two loops', 'pairwise', 'compare each', 'check all', 'check every', 'compare all', 'try each'],
    ...
    },
    {
      ...
      contextualEvidencePatterns: [
        ...
        'scan again',
        'scanning again',
        'rescanning old numbers',
        'checking values already checked',
    ...
    },
    {
      ...
      expectedEvidencePatterns: [
        ...
        'return true on duplicate',
        'return true on a duplicate',
      ...
      contextualEvidencePatterns: [
        ...
        'return true if duplicate',
        '^return true$',
        'already in the set that is a duplicate',
        'hit in the set means return true',
        'find it in the set we return true',
        'seen before return true',
        'contains it return true',
        'check returns true we return true',
        'already present we have our answer true',
        'seen it before',
        'we have seen it before',
        'we know we have seen it',
        'we know we have seen it before',
        'already seen that number',
        'already encountered',
        'already been seen',
        'appeared before',
      ],
    ...
    },
    {
      ...
      expectedEvidencePatterns: ['add it', 'insert', 'put in set', 'add to the set', 'add to set', 'save it', 'store it in set', 'add the value', 'add the number'],
...
export const TWO_SUM_CANONICAL: ApproachGraph = {
  ...
  nodes: [
    ...
    },
    {
      ...
      expectedEvidencePatterns: ['looking for matching', 'rescanning', 'searching the rest', 'repeatedly looking', 'keep searching', 'searching again', 'scan again', 'o(n^2)', 'o(n²)', 'quadratic', 'already checked', 'checked before'],
    ...
    },
    {
      ...
      expectedEvidencePatterns: ['return both indices', 'return [map[comp], i]', 'return the indices', 'found complement', 'complement in the map', 'complement in map', 'found in map', 'found in the map'],
...
export const STOCK_CANONICAL: ApproachGraph = {
  ...
  nodes: [
    ...
    },
    {
      ...
      expectedEvidencePatterns: ['cheapest price', 'lowest price so far', 'min price', 'track the minimum', 'remember the cheapest', 'lowest price', 'min_price', 'minimum price', 'running minimum', 'minimum price seen so far', 'lowest buy price'],
      contextualEvidencePatterns: [
    ...
    },
    {
      ...
      expectedEvidencePatterns: ['today price minus min', 'prices[i] - min_price', 'current - min', 'subtract min', 'today - min', 'price - min', 'price minus the minimum price', 'price minus min price', 'current price minus min price', 'current price minus the minimum price'],
    ...
    },
    {
      ...
      expectedEvidencePatterns: ['update max profit', 'update the maximum profit', 'update maximum profit', 'max(maxProfit', 'keep highest profit', 'track max profit', 'max_profit'],
...
export const VALID_PARENTHESES_CANONICAL: ApproachGraph = {
  ...
  nodes: [
    ...
    },
    {
      ...
      expectedEvidencePatterns: ['push opening', 'push to stack', 'if open bracket push', 'push it', 'add open to stack', 'opening brackets', 'store opening brackets'],
    ...
    },
    {
      ...
      expectedEvidencePatterns: ['pop and check', 'matches top', 'mismatch return false', 'pop from stack', 'pop', 'match closing', 'pop the top', 'pop top and check', 'pop top and check match'],
...
export const BINARY_SEARCH_CANONICAL: ApproachGraph = {
  ...
  nodes: [
    ...
    },
    {
      ...
      expectedEvidencePatterns: ['left = mid + 1', 'right = mid - 1', 'eliminate half', 'halve search space', 'throw away half', 'discard half', 'impossible', 'left and right boundary', 'left and right pointers', 'boundary pointers', 'move right pointer', 'move right', 'shift left or right'],
...
export const PROBLEM_GRAPHS: Record<string, ApproachGraph[]> = {
  ...
  'buy-sell-stock': [STOCK_CANONICAL],
