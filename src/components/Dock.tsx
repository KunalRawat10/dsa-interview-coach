...
function DockLabel({ children, className = '', ...rest }: { children: ReactElement | string; className?: string; isHovered?: ReturnType<typeof useMotionValue<number>> }) {
...
function DockIcon({ children, className = '' }: { children: ReactElement; className?: string }) {
